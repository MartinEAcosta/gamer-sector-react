...
export const Arrow = ( { direction } ) => {
    ...
    return (
        <div className={`cursor-pointer transition-transform ease-in-out hover:scale-105 flex ${ tailwindProp } absolute justify-center self-center bg-slate-50 rounded-full h-14 w-12 shadow-2xl`}>
